...
### 補足: GPU 世代と Memphis について

本エントリで頻出する 3 つの固有名詞を整理しておく。

#### Hopper（ホッパー）

NVIDIA の GPU アーキテクチャ世代名。コンピュータ科学者 Grace Hopper（COBOL 開発者、海軍少将）から命名。

- 製品: **H100**（2022年）、**H200**（2024年、メモリ強化版）
- 位置づけ: ChatGPT 以降の AI 学習・推論のデファクトスタンダードになった世代
- Colossus 1 の主力（約 87%）

#### Blackwell（ブラックウェル）

Hopper の次世代アーキテクチャ。統計学者 David Blackwell から命名。

- 製品: B100/B200（単体 GPU）、**GB200**（Grace CPU + Blackwell GPU 2基を1パッケージ化した Superchip）
- 性能: FP8 演算でカード当たり Hopper の約 2.5 倍
- Colossus 2 の主力。Colossus 1 にも GB200 が 3 万枚混在
...
| **Blackwell** | **B100 / B200 / GB200** | **2024-2026** |
| Rubin（予定） | — | 2026以降 |

#### Memphis（メンフィス）

米国テネシー州メンフィス市のこと。アーキテクチャ名ではなく都市名。

- xAI が Colossus 1 / Colossus 2 の両データセンターを構築している場所
- 旧 Electrolux 工場跡地（Boxtown 地区）を転用
- 選定理由: 広大な敷地、TVA（テネシー川流域開発公社）からの大容量電力調達、天然ガス発電所の併設
- AI データセンター立地で最重要の「数 GW 規模の電力契約が現実的に可能な希少拠点」として注目
